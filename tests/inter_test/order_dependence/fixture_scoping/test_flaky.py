"""
This test showcases flakiness due to an implicit ordering dependence between
tests created by a fixture that is scoped to the module level - i.e. if the fixture
was properly scoped to the function level, the test would not be flaky.
"""
